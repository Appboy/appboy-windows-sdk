...
namespace TestApp.Store.Pages {
  ...
  public sealed partial class SettingsPage : Page {
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e) {
      ...
      var useCustomSettings = (bool?) Windows.Storage.ApplicationData.Current.LocalSettings.Values[CustomSlideupKey];
    ...
    private void SlideupCheckBox_Checked(object sender, RoutedEventArgs e) {
      Windows.Storage.ApplicationData.Current.LocalSettings.Values[CustomSlideupKey] = true;
    ...
    private void SlideupCheckBox_Unchecked(object sender, RoutedEventArgs e) {
      Windows.Storage.ApplicationData.Current.LocalSettings.Values[CustomSlideupKey] = false;
